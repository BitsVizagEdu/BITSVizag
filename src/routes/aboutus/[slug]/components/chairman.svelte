...
<section class="hidden xl:block bg-slate-200 p-10">
	<div class="w-full max-w-[1200px] mx-auto px-4 md:px-10">
		<div class="text-red1 text-center xs:text-[20px] sm:text-[25px] font-bold pb-6 xl:col-span-2">
			<h2 class="uppercase">Message From The Secretary & Correspondent</h2>
		</div>
...
<section class="xl:hidden py-4 md:py-8 overflow-hidden">
	<div class="w-full">
		<div
			...
			data-aos="fade-down"
		>
			<h2 class="uppercase leading-tight">
				Message From The <br class="md:hidden" /> Secretary & Correspondent
			</h2>
		...
		<div class="flex flex-col gap-10 items-center">
			...
			<div id="text-mobile" class="px-6" data-aos="fade-up">
				<div class="space-y-6">
					...
					>
						My success mantra is simple — walk the talk, embrace challenges, and practice
						transparency with relentless hard work. With BITS Vizag as my extended family, I
						continue striving to shape young minds into responsible citizens.
					</p>
				</div>
			</div>
		</div>
