<section class=" bg-slate-200 p-10">
    <div class="flex flex-row lg:flex-row  3xs:flex-col justify-center items-center  mx-auto lg:max-h-[800px] max-w-[1080px] ">
        <div id="text" class=" lg:w-[900px] 3xs:mb-3 lg:px-10">
            ...
            <div>
                 <p class="text-justify md:text-[15px] tracking-widest  md:font-normal lg:leading-6 my-1 3xs:font-light xs:text-sm tracking-wide py-1">
                    There is also an ample of scope in co-curricular and extracurricular activities at BITS Vizag wherein the students are encouraged to show their talents. BITS Vizag ensures that the students prove themselves to be not only well qualified engineers but also very responsible and ideal citizens of our country.
                </p>
            </div>

        </div>
        <div id="pic " class="flex flex-col justify-between ">
            <div><img src="/principal.jpg" class="  p-3 rounded-md h-auto">
            </div>
