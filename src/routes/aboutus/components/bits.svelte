<section class=" bg-slate-200 p-10 rounded-lg">
    <div class="flex  flex-col-reverse justify-center items-center  mx-auto   ">
        <div id="text" class=" lg:w-[90%] 3xs:mb-3 lg:px-10">
            ...
            <div>
                <p class="text-justify md:text-[15px]  lg:text-[20px] tracking-widest mt-4  md:font-normal lg:leading-6 my-1 3xs:font-light xs:text-sm  tracking-wide py-1">
        ...
        <div id="pic " class="flex flex-col justify-between ">
            <div class="rounded-lg"><img src="/baba.jpeg" class=" 3xs:w-full xs:w-full md:h-[420px] p-3">
            </div>
