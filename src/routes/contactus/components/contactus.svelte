<div class="bg-gray-800 pb-20 ">
    ...
    <div class="text-center bg-slate-800 font-sans xs:px-0 ">
        <div class="flex flex-col justify-center items-center pb-11">
            ...
            <div class="grid xl:grid-cols-4 lg:grid-cols-4 gap-2 md:grid-cols-2 xs:grid-cols-1   items-center  bg-slate-800">
                <div class="card h-[200px] w-[250px] bg-sortwhite flex flex-col items-center m-2 rounded-[5px]">
                    ...
                    <div class="capitalize overflow-hidden text-center pt-2"><a href="mailto:principal@bitsvizag.com">principal@bitsvizag.com</a>
                    </div>
                </div>
                <div class="card h-[200px] w-[250px] bg-sortwhite flex flex-col items-center m-2 rounded-[5px]">
                    <div>
                    ...
                    <div class="capitalize overflow-hidden text-center pt-2"><a href="mailto:principal@bitsvizag.com">acadamic
                        advisor@bitsvizag.com</a></div>
                </div>
                <div class="card h-[200px] w-[250px] bg-sortwhite flex flex-col items-center m-2 rounded-[5px]">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <div class="capitalize overflow-hidden text-center pt-2"><a href="mailto:principal@bitsvizag.com">Administrative
                        Officer@bitsvizag.com</a></div>
                </div>
                <div class="card h-[200px] w-[250px] bg-sortwhite flex flex-col items-center m-2 rounded-[5px]">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <div class="capitalize overflow-hidden text-center pt-2"><a href="mailto:tpo@bitsvizag.com">tpo@bitsvizag.com</a>
                    </div>
                </div>
