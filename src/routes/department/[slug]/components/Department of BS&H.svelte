...
<script>
	...
	const stats = [
		...
		{ num: '600+', label: 'Students',       sub: 'Enrolled annually'  },
		{ num: '25+',  label: 'Faculty',        sub: 'Expert educators'   },
		{ num: '100%', label: 'Foundation',     sub: 'For all disciplines' },
	];
	...
	<section class="s-about">
		<div class="shell">
			<div class="about-inner" use:reveal={0}>
				...
				<div class="about-rhs">
					<p class="body-text">
						The Department of Basic Sciences and Humanities at BITS Vizag Engineering College is
						a fundamental academic unit dedicated to providing a strong foundation for all
						engineering disciplines. We offer courses in mathematics, physics, chemistry, English,
						and other humanities subjects — equipping every student with the essential knowledge
						to excel in their chosen engineering field.
					</p>
					<p class="body-text" style="margin-top:1rem;">
						...
						classrooms, well-equipped laboratories, language labs, and dedicated faculty, we
						create an environment where analytical thinking and interdisciplinary education
						flourish.
					</p>
...
.scrim {
	position: absolute; inset: 0;
	background:
		linear-gradient(to top,  rgba(4,20,12,0.94) 0%, rgba(4,20,12,0.36) 52%, transparent 100%),
...
@media (max-width: 640px) {
	...
	.s-faculty-cta { padding: 3rem 0 4rem; }
