			...
			>
				<div class="hod-container">
					<div class="hod-visual" in:fly={{ x: -40, duration: 800 }}>
						...
						<img src="/mec hod.jpg" alt="Dr. A. S. Bhanu Prasanna" loading="lazy" />
						<div class="hod-badge satoshi">19+ Years Exp</div>
					</div>
					<div class="hod-content" in:fly={{ x: 40, duration: 800 }}>
						...
						<h2 class="satoshi">Dr. A. S. Bhanu Prasanna</h2>
						<p class="hod-designation inter">
							Head of Department | Mechanical Engineering
						</p>
						<div class="hod-message-body">
							<p class="inter">
								“We empower our students to bridge the gap between theoretical mechanics and real-world industrial applications through innovation and ethics.”
							</p>
							<p class="inter signature">Dr. A. S. Bhanu Prasanna</p>
						</div>
					</div>
				</div>
			</section>
