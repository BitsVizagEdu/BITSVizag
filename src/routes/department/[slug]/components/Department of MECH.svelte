		...
		<div>
			...
			<div class="pt-10">
				<h1 id="HOD" class="text-4xl font-bold text-indigo-900 text-center mb-8">
					HOD MESSAGE <span class="text-red-600"> - Prof. A.S. Bhanu Prasana</span>
				</h1>
						...
						<div class="flex">
							...
							<div class="text-[#08163d] text-justify">
								<p>
									...
									classified into Convener Quota (CATEGORY – A) and Management Quota (CATEGORY – B)
									at the first year level and Lateral Entry at the second year level.
								</p>
							</div>
						</div>
					</div>
