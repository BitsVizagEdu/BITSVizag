...
<section class="bg-slate-200 p-4 md:p-8 lg:p-10 rounded-xl md:rounded-3xl">
	<img src="/header/cse.png" alt="Header" class="w-full h-auto object-contain rounded-xl shadow-sm mb-4 md:mb-6" />
		...
		<div id="facilities" class="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-20 w-full max-w-5xl mx-auto pt-4 md:pt-8 px-2 lg:px-0">
			<div class="flex-1 flex flex-col gap-3">
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Computer Science Laboratory</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">C Programming Laboratory</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">IT Workshop</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Advance Data Structure Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">OOPs Through JAVA Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Computer Science Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Information Technology Workshop</p>
				</div>
			</div>
			<div class="flex-1 flex flex-col gap-3 md:gap-4">
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Free & Open Source Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Operating System & Compiler Designing Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
				...
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Computer Network & Unix Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Advance JAVA & Web Development Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">UML & DP Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Mobile Application Development Lab</p>
				</div>
			</div>
		</div>
	...
	<div class="flex md:hidden flex-col gap-3 px-2 md:px-0 mt-4 md:mt-0 pb-4">
		<p class="text-[14px] leading-relaxed text-slate-700 text-left">The Department of Computer Science and Engineering (CSE) at BITS Vizag Engineering College is a dynamic and vibrant academic unit dedicated to providing top-notch education and research opportunities in the field of computer science and engineering.</p>
		<ul class="flex flex-col gap-2 mt-2">
            <li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                ...
                <span class="text-[13px] text-slate-600 leading-snug tracking-wide">It is committed to producing skilled and competent professionals who can address the ever-changing demands of the technology industry.The CSE department at BITS Vizag Engineering College boasts world-class infrastructure and facilities to support its academic and research endeavors.</span>
            </li>
            <li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                <i class="fa-solid fa-check-circle text-blue-500 text-[14px] mt-0.5 shrink-0"></i>
                <span class="text-[13px] text-slate-600 leading-snug tracking-wide">The curriculum is designed to strike a balance between theoretical knowledge and practical skills, empowering students with a strong foundation in core computer science concepts and the ability to apply them to real-world problems.The Department of Computer Science and Engineering at BITS Vizag Engineering College plays a crucial role in shaping the future of the technology landscape.</span>
            </li>
            <li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                <i class="fa-solid fa-check-circle text-blue-500 text-[14px] mt-0.5 shrink-0"></i>
                <span class="text-[13px] text-slate-600 leading-snug tracking-wide">Welcome to the Department of Computer Science.</span>
            </li>
		</ul>
	</div>
