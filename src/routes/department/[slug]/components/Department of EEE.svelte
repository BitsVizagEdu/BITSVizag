<script>
	...
	const stats = [
		...
		{ num: '120+', label: 'Students', sub: 'Enrolled annually' },
		{ num: '22+', label: 'Faculty', sub: 'Expert engineers' },
		{ num: '80%', label: 'Placements', sub: 'Year on year' }
	];
			...
			<div class="about-inner" use:reveal={0}>
				...
				<div class="about-rhs">
					<p class="body-text">
						...
						College is dedicated to high-quality education and research in electrical and
						electronics engineering. We produce skilled engineers who contribute to power systems,
						telecommunications, renewable energy, and automation across industries.
					</p>
					<p class="body-text" style="margin-top:1rem;">
						Our comprehensive curriculum covers electrical circuits, power systems, control systems,
						digital signal processing, communication systems, and renewable energy — all backed by
						modern infrastructure and state-of-the-art facilities that support our academic and
						research ambitions.
					</p>
...
<style>
	...
	*::after {
	...
	.accent-line {
		width: 36px;
		height: 3px;
		background: linear-gradient(90deg, var(--sky-700), var(--sky-300));
		border-radius: 2px;
		margin-top: 1.25rem;
	}
	.body-text {
	...
	.stats-card {
		...
		box-shadow:
			...
			0 16px 48px rgba(3, 105, 161, 0.28),
	...
	.stats-card::before {
		...
		inset: 0;
		background:
			radial-gradient(ellipse at 10% 60%, rgba(56, 189, 248, 0.2), transparent 52%),
			radial-gradient(ellipse at 90% 30%, rgba(12, 74, 110, 0.4), transparent 50%);
		pointer-events: none;
	}
	.stat-cell {
		flex: 1;
