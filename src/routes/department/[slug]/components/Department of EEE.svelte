		...
		<div id="facilities" class="flex gap-20 py-5 facilities">
			<div>
				...
				<div id="icon" class="flex">
					...
					<p>Microprocessors & Microcontrollers Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
					...
					<p>Linear & Digital IC Applications Lab</p>
				</div>
			</div>
			<div>
				<div id="icon" class="flex">
					...
					<p>Power Electronics & Drives Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
				...
				<div id="icon" class="flex">
					...
					<p>Power Systems Simulation Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
