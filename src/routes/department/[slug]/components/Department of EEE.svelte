...
<section class="bg-slate-200 p-4 md:p-8 lg:p-10 rounded-xl md:rounded-3xl">
	...
	<div class="flex md:hidden flex-col gap-3 px-2 md:px-0 mt-4 md:mt-0 pb-4">
		<p class="text-[14px] leading-relaxed text-slate-700 text-left">
			The Department of Electrical and Electronics Engineering (EEE) at BITS Vizag Engineering
			College is a prominent academic unit dedicated to providing high-quality education and
			research opportunities in the field of electrical and electronics engineering.
		</p>
		<ul class="flex flex-col gap-2 mt-2">
			<li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
				...
				<span class="text-[13px] text-slate-600 leading-snug tracking-wide"
					>This department plays a pivotal role in producing skilled engineers who contribute to
					various industries, including power systems, electronics, telecommunications, renewable
					energy, and automation.</span
				>
			</li>
			<li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
				<i class="fa-solid fa-check-circle text-blue-500 text-[14px] mt-0.5 shrink-0"></i>
				<span class="text-[13px] text-slate-600 leading-snug tracking-wide"
					>The EEE department offers a comprehensive and up-to-date curriculum that covers a wide
					range of subjects related to electrical and electronics engineering.</span
				>
			</li>
			<li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
				<i class="fa-solid fa-check-circle text-blue-500 text-[14px] mt-0.5 shrink-0"></i>
				<span class="text-[13px] text-slate-600 leading-snug tracking-wide"
					>The curriculum includes courses on electrical circuits, power systems, control systems,
					electronics, digital signal processing, communication systems, and renewable energy.</span
				>
			</li>
		</ul>
	</div>
