...
<section class=" bg-slate-200 3xs:p-4 md:p-10 rounded-lg">
	...
	<div class="text-justify flex flex-col gap-5 mt-5 text-lg">
		<div>
			...
			Cyber Security is the crucial science of protecting networks, devices, and data from
			unauthorized access or criminal use, while ensuring confidentiality, integrity, and
			availability of information.
		</div>
		<div>
			<p>
				By integrating advanced security protocols into our core curriculum, we move beyond basic
				programming to teach students how to identify vulnerabilities, mitigate risks, and build
				resilient systems that protect global infrastructures, financial networks, and personal
				data.
			</p>
			<p class="pt-3">
				...
				state-of-the-art security operation centers and hands-on labs needed to master digital
				forensics, ethical hacking, and cryptography. At BITS Vizag, we are committed to shaping
				vigilant professionals who don’t just understand digital threats, but actively innovate to
				secure the future of the global digital economy.
			</p>
		</div>
		<div class="pt-10">
			...
			<div class="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
				...
				>
					<p>
						...
						more sophisticated and pervasive than ever before.By blending theoretical foundations
						with intensive laboratory work, we ensure that our students understand the underlying
						architecture of the digital world and the myriad ways it can be compromised.
					</p>
					<p>
						We provide a rigorous, hands-on learning environment focused on critical domains such as
						vulnerability assessment, real-time threat mitigation, and complex digital forensics.
						This comprehensive approach empowers you to stay ahead of malicious actors and secure
						sensitive data across diverse platforms. We invite you to join our mission at BITS
						Vizag: stay vigilant, stay innovative, and stay true to your purpose of securing the
