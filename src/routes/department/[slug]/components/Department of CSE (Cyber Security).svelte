<script>
	...
	const jobRoles = [
		...
		},
		{
			...
			description: 'Ensuring software applications are secure throughout their entire lifecycle.',
			skills: ['OWASP', 'SAST/DAST', 'DevSecOps', 'Secure Coding'],
	...
	<div class="main-content-layout">
		...
		<section id="jobs" class="dept-section-card jobs-ultra-section">
			...
			<div class="roadmap-ultra-container">
				<h3 class="satoshi roadmap-u-title">Security Specialist Roadmap</h3>
		...
		<section id="hod" class="dept-section-card hod-premium-card" style="--section-accent: #db2777">
			<div class="hod-container">
				<div class="hod-visual" in:fly={{ x: -40, duration: 800 }}>
					...
					<img src={joshuaImg} alt="Prof. P Joshua Raju" loading="lazy" />
					<div class="hod-badge satoshi">12+ Years Exp</div>
				</div>
				<div class="hod-content" in:fly={{ x: 40, duration: 800 }}>
					...
					<h2 class="satoshi">Prof. P Joshua Raju</h2>
					<p class="hod-designation inter">Head of Department | CSE (Cyber Security)</p>
					<div class="hod-message-body">
						<p class="inter">
							"Welcome to the Cyber Security specialisation. Our mission is to nurture technical
							leadership and pioneer research in digital defense, blending rigorous security
							fundamentals with cutting-edge ethical hacking."
						</p>
						<p class="inter signature">Prof. P Joshua Raju</p>
					</div>
				</div>
			</div>
		</section>
		...
		<section id="contact" class="dept-section-card contact-ultra-section">
			<div class="contact-ultra-banner">
				...
				<div class="c-u-actions">
					<a
						href="mailto:cse.cyber@bitsvizag.com"
					...
					>
						...
						<div class="c-u-info">
							...
							<span class="val satoshi">tpo@bitsvizag.com</span>
						</div>
					</a>
					<a
					...
					>
						...
						<div class="c-u-info">
							...
							<span class="val satoshi">+91 8297293834</span>
						</div>
					</a>
				</div>
			</div>
...
<style>
	...
	.header-hero {
		height: 430px;
		background: #0d1117 url('/Cyber-security-news-header.jpg') center/cover;
		position: relative;
		display: flex;
		align-items: center;
	...
	@media (max-width: 768px) {
		...
		.vision-quote {
			...
			animation: visionShimmer 3s linear infinite !important;
	...
	@media print {
		...
		.dept-premium-root::after {
			content: '© 2026 BABA INSTITUTE OF TECHNOLOGY AND SCIENCES (BITS VIZAG) - Department of CSE (Cyber Security)';
			display: block;
			text-align: center;
			font-size: 0.75rem;
			color: #94a3b8;
