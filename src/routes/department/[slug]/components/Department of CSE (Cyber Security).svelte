	...
	<section class="s-about">
		<div class="shell">
			<div class="about-inner" use:reveal={0}>
				...
				<div class="about-rhs">
					<p class="body-text">
						The Department of Computer Science at BITS Vizag is at the forefront of digital
						defence, focusing on Cyber Security to prepare students for a rapidly evolving,
						interconnected world. Cyber Security is the science of protecting networks, devices,
						and data from unauthorised access — ensuring confidentiality, integrity, and
						availability of information at every layer.
					</p>
					<p class="body-text" style="margin-top:1rem;">
						In today's digital landscape, Cyber Security is no longer just an IT concern — it is
						a fundamental necessity for national security and modern commerce. Our department
		...
		<div class="shell">
			...
			<div class="mosaic" use:reveal={60}>
				<div class="m-hero m-tile">
					<img src="/CS-Banners/CS-images/get.jpg" alt="Security Operations Centre" loading="lazy" />
					<div class="m-label">Security Operations Centre</div>
				</div>
				<div class="m-grid">
					<div class="m-tile"><img src="/CS-Banners/CS-images/get (1).jpg" alt="Network Lab" loading="lazy" /></div>
					<div class="m-tile"><img src="/CS-Banners/CS-images/get4.jpg"    alt="Forensics Lab" loading="lazy" /></div>
					<div class="m-tile"><img src="/CS-Banners/CS-images/get3.jpg"    alt="Crypto Lab" loading="lazy" /></div>
					<div class="m-tile"><img src="/CS-Banners/CS-images/get5.jpg"    alt="Pen Testing Lab" loading="lazy" /></div>
				</div>
			</div>
...
.scrim {
	position: absolute; inset: 0;
	background:
		linear-gradient(to top,  rgba(10,4,26,0.94) 0%, rgba(10,4,26,0.36) 52%, transparent 100%),
