...
<section class="bg-slate-200 p-4 md:p-8 lg:p-10 rounded-xl md:rounded-3xl">
	...
	>
		<div>
			<p>
				...
				revolution, focusing on Artificial Intelligence (AI) and Machine Learning (ML) to prepare
				students for a tech-driven future. AI is the science of creating smart systems that can
				think and decide like humans, while ML allows these systems to learn and improve
				automatically from data.
			</p>
		</div>
		<div>
			<p>
				By integrating these technologies into our core curriculum, we move beyond traditional
				coding to teach students how to build autonomous systems that solve real-world problems in
				healthcare, finance, and global sustainability.
			</p>
			<p class="pt-3">
				In this generation, AI and ML are no longer just concepts—they are the engines of modern
				life, powering everything from personalized medicine to smart cities. Our department
				provides the high-tech infrastructure and hands-on labs needed to master these tools,
				bridging the gap between complex mathematical theories and practical industry applications.
				At BITS Vizag, we are committed to shaping skilled professionals who don’t just use
				technology, but actively innovate and lead the next wave of the global AI revolution.
			</p>
		</div>
		<div class="pt-10">
	...
	<div class="flex md:hidden flex-col gap-3 px-2 md:px-0 mt-4 md:mt-0 pb-4">
		<p class="text-[14px] leading-relaxed text-slate-700 text-left font-medium">"Welcome to the Department of Computer Science."</p>
		<ul class="flex flex-col gap-2 mt-2">
            <li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                ...
                <span class="text-[13px] text-slate-600 leading-snug tracking-wide">As an accomplished academic leader with extensive experience in computer science and engineering, I oversee our academic and research activities with a forward-thinking vision.</span>
            </li>
            <li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                <i class="fa-solid fa-check-circle text-blue-500 text-[14px] mt-0.5 shrink-0"></i>
                <span class="text-[13px] text-slate-600 leading-snug tracking-wide">We are committed to fostering a culture of innovation and excellence, ensuring that both our students and faculty are equipped with the latest knowledge and skills.</span>
            </li>
            <li class="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                <i class="fa-solid fa-check-circle text-blue-500 text-[14px] mt-0.5 shrink-0"></i>
                <span class="text-[13px] text-slate-600 leading-snug tracking-wide">Through a collaborative approach, we promote strong industry-academia interactions, creating valuable opportunities for student growth, placements, and research endeavors.</span>
            </li>
		</ul>
	</div>
		...
		<div id="facilities" class="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-20 w-full max-w-5xl mx-auto pt-4 md:pt-8 px-2 lg:px-0">
			<div class="flex-1 flex flex-col gap-3">
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Artificial Intelligence Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Machine Learning Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Deep Learning & Neural Networks Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Data Science & Analytics Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Python Programming for AI Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Natural Language Processing Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Computer Vision Lab</p>
				</div>
			</div>
			<div class="flex-1 flex flex-col gap-3 md:gap-4">
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Big Data Analytics Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Cognitive Computing Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">AI & IoT Integration Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Cloud Computing for AI Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">Advanced Robotics Lab</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">R Programming Laboratory</p>
				</div>
				<div class="flex items-center gap-4 bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
					<div class="shrink-0 text-blue-600 bg-blue-50 p-2 md:p-2.5 rounded-lg group-hover:bg-blue-100 group-hover:text-blue-700 transition-colors">
						<svg
					...
					<p class="font-semibold text-slate-800 text-[14.5px] md:text-[15px] text-left flex-1 leading-snug tracking-normal">High-Performance GPU Computing Center</p>
				</div>
			</div>
		</div>
