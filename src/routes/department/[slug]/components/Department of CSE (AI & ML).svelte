		...
		<div id="facilities" class="flex gap-20 facilities">
			<div>
				...
				<div id="icon" class="flex">
					...
					<p>Deep Learning & Neural Networks Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
					...
					<p>Data Science & Analytics Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
					...
					<p>Python Programming for AI Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
					...
					<p>Natural Language Processing Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
			...
			<div>
				...
				<div id="icon" class="flex">
					...
					<p>Cloud Computing for AI Lab</p>
				</div>
				<div id="icon" class="flex">
					<svg
						width="40px"
				...
				<div id="icon" class="flex">
					...
					<p>High-Performance GPU Computing Center</p>
				</div>
			</div>
		</div>
