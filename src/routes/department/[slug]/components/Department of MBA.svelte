<section class=" bg-slate-200 3xs:p-4  md:p-10 rounded-lg">
	...
	<div class="text-justify flex flex-col gap-5 mt-5 text-lg">
		...
		<div>
			...
			<p class="pt-3">
				The Department of Management Studies at BITS Vizag Engineering College plays a pivotal role
				in shaping the future business leaders of tomorrow.
			</p>
		</div>
		<div class="pt-10">
			<h1 id="HOD" class="text-3xl font-bold text-indigo-900">HOD MESSAGE - Prof. K. Sireesha</h1>
		...
		<div class="text-justify mt-8 text-lg flex flex-col gap-5">
			<p>
				The Department Head of Management Studies at BITS Vizag Engineering College is a
				distinguished and accomplished academic leader with expertise in the field of management.
				With a wealth of knowledge and experience, the department head oversees the department's
				academic and research activities with utmost proficiency. They foster a culture of
				innovation, entrepreneurship, and excellence, inspiring both faculty and students to excel
				in their pursuits. Through their strong industry connections, the department head promotes
				industry-academia collaborations and creates valuable opportunities for student placements
				and internships. Under their visionary guidance, the Management Studies department continues
				to produce skilled business leaders equipped to navigate the challenges of the dynamic
				corporate world.
			</p>
		</div>
		<div>
