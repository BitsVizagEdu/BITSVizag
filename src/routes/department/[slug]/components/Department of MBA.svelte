	...
	>
		...
		<div class="pt-10">
			<h1 id="HOD" class="text-4xl font-bold text-indigo-900 text-center mb-8">
				HOD MESSAGE <span class="text-red-600"> - Prof. K. Sireesha</span>
			</h1>
		...
		<div class="parent mt-7">
			<div class="child flex items-center justify-center text-white">
				<div class="">
					...
					<p id="basic" class="text-xl font-bold pt-4">MANAGEMENT STUDIES</p>
				</div>
			</div>
		</div>
		<div id="academic" class="flex gap-7"></div>
	</div>
	<div />
	<div>
		...
		<div>
			<p class="text-justify pt-5 text-[#08163d]">
				BITS Engineering College admits candidates through the eligibility requirements and under
				management quota.
			</p>
			<div class="flex pt-5">
				<div>
			...
			<div class="flex">
				...
				<div class="text-[#08163d] text-justify">
					<p>
						Categories of seats: The sanctioned seats in each program in the college are classified
						into Convener Quota (CATEGORY – A) and Management Quota (CATEGORY – B) at the first year
						level and Lateral Entry at the second year level.
					</p>
				</div>
			</div>
		</div>
