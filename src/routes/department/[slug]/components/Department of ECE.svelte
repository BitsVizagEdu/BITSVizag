			...
			<div id="facilities" class="flex gap-20 facilities">
				<div>
					...
					<div id="icon" class="flex">
						...
						<p>Basic Electrical Engineering Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
						...
						<p>Electronic Devices & Circuits Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
						...
						<p>Switching Theory & Logic Design Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
						...
						<p>Electronic Circuit Analysis Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
				...
				<div>
					...
					<div id="icon" class="flex">
						...
						<p>Analog ICs & Application Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
					...
					<div id="icon" class="flex">
						...
						<p>Microprocessor & Microcontrollers Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
						...
						<p>ARM based / Aurdino based Programming Lab</p>
					</div>
					<div id="icon" class="flex">
						<svg
							width="40px"
