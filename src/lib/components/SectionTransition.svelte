<script>
	...
	onMount(() => {
		...
		// Hero fade out and scale down on scroll
		...
		// Parallax shift for the transition layer
		gsap.to('.transition-layer-parallax', {
			scrollTrigger: {
