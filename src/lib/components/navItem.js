...
},
{
  "name": "About us",
  "folder": "/aboutus",
  "items": ["About-Trust", "About-BITS", "Message-from-Chairman", "Message-from-Principal"],
  "icon": `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 h-6 ">
...

{
  "name": "Academics",
  "folder": "/department",
  "items": ["Department of BS&H", "Department of CSE", "Department of CSE (AI & ML)", "Department of CSE (Cyber Security)", "Department of ECE", "Department of EEE", "Department of MECH", "Department of CIVIL", "Department of MBA", "Department of Admin"],
  "icon": `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 h-6 ">
