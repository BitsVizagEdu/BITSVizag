...
export const NavItems = writable([
    ...
    {
        "name": "About us",
        "items": ["About Bits", "Message from Chairman", "Message from Secretary & Correspondent", "Message form Principal"],
        "icon":`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 h-6 ">
    ...
    },
    {
        "name": "Events",
        "items": [],
        "icon":`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 h-6 ">ext-purpleS2">
