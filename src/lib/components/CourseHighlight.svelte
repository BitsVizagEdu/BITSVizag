...
<section class="pathways-section" on:mouseleave={handleMouseLeave}>
	...
	<div class="pathways-header">
		...
		<p class="header-desc">
			Discover our AICTE-approved, UGC-recognised engineering programmes. Crafted to align with
			global industry demands and build exceptional careers.
		</p>
	</div>
	...
	<div class="capsule-list" role="list">
		{#each courses as course, i}
			...
			>
				<!-- Background Image -->
				<img src={course.image} alt={course.title} class="card-bg-image" loading="lazy" />
					...
					<a href={course.href} class="icon-circle" aria-label="Explore {course.title}">
						...
						{:else if course.title === 'AI & ML'}
							<svg
								...
								fill="none"
								viewBox="0 0 14 14"
								id="Cyborg-2--Streamline-Flex-Gradient"
								height="22"
								width="22"
							>
						...
						{:else if course.title === 'Cyber Security'}
							<svg
								...
								fill="none"
								viewBox="0 0 14 14"
								id="Fingerprint-Cyber-Streamline-Flex-Gradient"
								height="22"
								width="22"
							>
						...
						{:else if course.title === 'ECE'}
							<svg
								...
								fill="none"
								viewBox="0 0 14 14"
								id="Cloud-Data-Transfer--Streamline-Flex-Gradient"
								height="22"
								width="22"
							>
						...
						{:else if course.title === 'EEE'}
							<svg
								...
								fill="none"
								viewBox="0 0 14 14"
								id="Charging--Streamline-Flex-Gradient"
								height="22"
								width="22"
							>
						...
						{:else if course.title === 'Mechanical'}
							<svg
								...
								fill="none"
								viewBox="0 0 14 14"
								id="Wrench-Hand--Streamline-Flex-Gradient"
								height="22"
								width="22"
							>
...
<style>
	...
	@media (max-width: 640px) {
		...
		.capsule-card {
			...
			flex: none !important;
			width: 100%;
			transition: height 0.45s cubic-bezier(0.25, 1, 0.5, 1), border-radius 0.45s cubic-bezier(0.25, 1, 0.5, 1);
