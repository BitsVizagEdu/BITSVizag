<section>
	<div class="font-font1 text-xl md:text-5xl text-center m-10 md:p-10">
		...
		<div class=" grid place-items-centerfont-mono mb-12 mx-5">
			...
			>
				...
				<div class="p-3 md:w-[25vw] ">
					...
					<p class="text-xs tracking-tighter text-gray-600">
						"Let your passion ignite the path to a remarkable and rewarding future; stay
						true to yourself."
					</p>
				</div>
			</div>
		...
		<div class=" grid place-items-centerfont-mono mb-12 mx-5">
			...
			>
				...
				<div class="p-3 md:w-[25vw]">
					...
					<p class="text-xs tracking-tighter text-gray-600">
						"Self-motivation and a hunger for knowledge lead the way to greatness; overcome setbacks
						with resilience."
					</p>
				</div>
			</div>
