	...
	<div class="text-justify flex flex-col gap-5 mt-5 text-lg">
		<div>
			<p>
				...
				opportunities in the field of mechanical engineering. This department plays a vital role in
				producing skilled engineers who contribute to various industries, including manufacturing,
				automotive, aerospace, energy, and more.
			</p>
		</div>
		<div>
			<p>
				The Mechanical Engineering department offers a comprehensive and up-to-date curriculum that
				covers a wide range of subjects related to mechanical engineering. The curriculum is
			...
			<p class="pt-3">
				...
				research and industry collaboration, the department ensures that students are well-prepared
				to meet the demands of the ever-evolving engineering industry.
			</p>
		</div>
		<div class="pt-10">
			<h1 id="HOD" class="text-3xl font-bold text-indigo-900">
				HOD MESSAGE - Prof. A.S. Bhanu Prasana
			</h1>
		...
		<div class="text-justify mt-8 text-lg flex flex-col gap-5">
			<p>
				The Department Head of Mechanical Engineering at BITS Vizag Engineering College is a
				distinguished and accomplished academic leader with a profound understanding of mechanical
				engineering principles. With a wealth of experience and expertise, the department head
				provides visionary leadership to the department, ensuring the delivery of high-quality
				education and research opportunities to students and faculty members. They foster a culture
				of innovation, excellence, and collaboration, encouraging faculty and students to engage in
				cutting-edge research projects. Through their guidance and mentorship, the department head
				inspires aspiring mechanical engineers to excel in their academic pursuits and prepares them
				to become skilled professionals who contribute significantly to the engineering industry.
			</p>
		</div>
		<div>
		...
		<div class="parent mt-7">
			<div class="child flex items-center justify-center text-white">
				<div class="">
					...
					<p id="basic" class="text-xl font-bold pt-4">MECHANICAL ENGINEERING</p>
				</div>
			</div>
		</div>
