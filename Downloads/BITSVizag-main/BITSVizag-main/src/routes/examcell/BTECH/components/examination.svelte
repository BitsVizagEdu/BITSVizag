<script>
	let isTimeTableVisible = false;
	let isResultsVisible = false;
	let isNotificationVisible = false;
	let isContactUsVisible = false;
	...
	function toggleContactUs() {
		isContactUsVisible = !isContactUsVisible;
	}
</script>
...
<section class="bg-slate-200 3xs:p-4 md:p-10 rounded-lg">
	<div class="flex flex-col-reverse justify-center items-center mx-auto">
		<div id="text" class="lg:w-[90%] 3xs:mb-3 lg:px-10">
			...
			>
				<h2 class="text-4xl">EXAMINATION</h2>
			</div>
				...
				<div class="table-cell first-cell last-cell flex justify-between items-center">
					<p class="text-xl font-sans">
						...
						<i
							...
							class:fa-angle-up={isTimeTableVisible}
							class:fa-angle-down={!isTimeTableVisible}
						/>
					</p>
				</div>
			</div>
				...
				<div id="dropdownContent" class="table-box">
					<div class="table-row">
						<div class="table-cell first-cell ">
							<p class="text-sm font-serif">I B.Tech I Semester Examinations Time Table</p>
						</div>
						<div class="table-cell last-cell">
							<a href="/examcell_docs/BTech/examination/notification/1-1-sem.pdf" target="_blank"
			...
			<!-- <div class="table-row table-head cursor-pointer" on:click={toggleResults}>
                <div class="table-cell first-cell last-cell flex justify-between items-center">
                    <p class="text-xl font-sans">
                        Results
                        <i class="fa-solid text-xl" class:fa-angle-up={isResultsVisible} class:fa-angle-down={!isResultsVisible}></i>
                    </p>
                </div>
            </div>
			...
			<div class="table-row table-head cursor-pointer" on:click={toggleNotification}>
				<div class="table-cell first-cell last-cell flex justify-between items-center">
					<p class="text-xl font-sans">
						...
						<i
							class="fa-solid text-xl"
							class:fa-angle-up={isNotificationVisible}
							class:fa-angle-down={!isNotificationVisible}
						/>
					</p>
				</div>
			</div>
					...
					<div class="table-row">
						<div class="table-cell first-cell ">
							<p class="text-sm font-serif">
								IV B.Tech I Sem Regular and Supply <br /> Examinations-October-2024
							</p>
						</div>
						<div class="table-cell last-cell">
							<a
								href="/examcell_docs/BTech/examination/notification/IV-B.Tech Regular and Supply Examination.pdf"
								target="_blank"><i class="fa-solid fa-file-pdf fa-beat text-2xl" /></a
							>
						</div>
					</div>
					<!-- <div class="table-row">
			...
			<div class="table-row table-head cursor-pointer" on:click={toggleContactUs}>
				<div class="table-cell first-cell last-cell flex justify-between items-center">
					<p class="text-xl font-sans">
						...
						<i
							class="fa-solid text-xl"
							class:fa-angle-up={isContactUsVisible}
							class:fa-angle-down={!isContactUsVisible}
						/>
					</p>
				</div>
			</div>
