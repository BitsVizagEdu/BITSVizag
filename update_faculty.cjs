...
// 1. We remove existing EEE and MECH faculty objects from facultyData array in faculty.svelte
...
let newFacultyDataStr = facultyDataStr.replace(/{\s*title: [\s\S]*?department: '(EEE|Mechanical)'[\s\S]*?},?/g, '');
